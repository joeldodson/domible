...
bio = {
    ...
    'projects': [ "list of projects as dicts",
        {'title': 'domible', 'url': 'https://github.com/joeldodson/domible'},
        {'title': 'atlassible', 'url': 'https://github.com/joeldodson/atlassible'},
    ]
    }
...
cases = {
    ...
    "lolol": [[1, 2, 3], [4, 5, 6], [[11,22,33], ['a', 'b', 'c', 'd']], ['annie', 'chelsea', 'maple']],
    ## list of randoms
